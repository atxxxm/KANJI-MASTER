...
The application is distributed under the **GPL-3** license.
You are free to **use, modify, and distribute** this software.

[Go to the GitHub repository](https://github.com/atxxxm/KANJI-MASTER)
...
*   **[egui](https://github.com/emilk/egui)** — a fast, highly portable, and ergonomic Immediate Mode GUI library.
*   **[rusqlite](https://github.com/rusqlite/rusqlite)** — an ergonomic wrapper for working with SQLite databases.
*   **[serde](https://serde.rs/)** — a powerful framework for serializing and deserializing data (JSON/TOML).
*   **[rust-embed](https://github.com/pyrossh/rust-embed)** — for embedding databases and assets directly into the binary.

---

## Fonts and Data Sources

*   **Font:** Uses [Noto Sans JP](https://fonts.google.com/noto/specimen/Noto+Sans+JP) by Google (OFL license).
